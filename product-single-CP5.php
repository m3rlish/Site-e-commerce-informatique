		...
		<div class="row">
			<div class="col-md-6">
				<ol class="breadcrumb">
					...
					<li><a href="shop-CP.php">CP Company</a></li>
					<li class="active">Diagonal Raised Fleece Zipped Sweatshirt</li>
				</ol>
			</div>
		...
		<div class="row mt-20">
					...
					<div id='carousel-custom' class='carousel slide' data-ride='carousel'>
						<div class='carousel-outer'>
							...
							<div class='carousel-inner '>
								<div class='item active'>
									<img src='images/shop/products/pull-CP-5.1.jpeg' alt='' data-zoom-image="images/shop/single-products/product-1.jpg" />
								</div>
								<div class='item'>
									<img src='images/shop/products/pull-CP-5.2.jpeg' alt='' data-zoom-image="images/shop/single-products/product-2.jpg" />
								</div>
								
								<div class='item'>
									<img src='images/shop/products/pull-CP-5.3.jpeg' alt='' data-zoom-image="images/shop/single-products/product-3.jpg" />
								</div>
								<div class='item'>
									<img src='images/shop/products/pull-CP-5.4.jpeg' alt='' data-zoom-image="images/shop/single-products/product-4.jpg" />
								</div>
						...
						<ol class='carousel-indicators mCustomScrollbar meartlab'>
							<li data-target='#carousel-custom' data-slide-to='0' class='active'>
								<img src='images/shop/products/pull-CP-5.1.jpeg' alt='' />
							</li>
							<li data-target='#carousel-custom' data-slide-to='1'>
								<img src='images/shop/products/pull-CP-5.2.jpeg' alt='' />
							</li>
							<li data-target='#carousel-custom' data-slide-to='2'>
								<img src='images/shop/products/pull-CP-5.3.jpeg' alt='' />
							</li>
							<li data-target='#carousel-custom' data-slide-to='3'>
								<img src='images/shop/products/pull-CP-5.4.jpeg' alt='' />
							</li>
			...
			<div class="col-md-7">
				<div class="single-product-details">
					<h2>Diagonal Raised Fleece Zipped Sweatshirt
					</h2>
				...
				<div class="tabCommon mt-20">
					...
					<div class="tab-content patternbg">
						<div id="details" class="tab-pane fade active in">
							...
							<p>Ce sweat-shirt présente un col montant confortable, une fermeture zippée sur toute la longueur sur le devant et des poches en biais pour les mains. Le détail en forme de verre de lunette C.P. Company est incrusté dans la poche sur la manche. Modèle confectionné dans notre molleton en relief diagonal, un coton bouclé mi-épais offrant un confort absolu et une grande robustesse.
							</p>
				...
				<div class="product-item">
					<div class="product-thumb">
						...
						<div class="preview-meta">
							<ul>
								<li>
									<a href="product-single-CP2.php" ><i class="tf-ion-ios-search-strong"></i></a> 
								</li>
								<li>
					...
					<div class="product-content">
						<h4><a href="product-single.php">Light Fleece Zipped Hoodie</a></h4>
						<p class="price">210€</p>
					</div>
				</div>
			</div>
