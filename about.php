	...
	<div class="container">
		...
		<div class="row">
			...
			<div class="col-md-6">
				...
				<img class="img-responsive" src="images/about/test.png">

			</div>

			<div class="col-md-6">

				<h2 class="mt-40">Qui sommes nous</h2>

				<p>Vous recherchez un site qui référence vos marques de vêtements streetwear préférées ?</p>

				<p>SNKRS est fait pour vous !</p>

				<p>Notre plateforme vous permet d’avoir un accès privé et centralise les plus grandes marques en tendance de nos jours.</p>

				<p>Nos clients sont toujours satisfaits puisque notre service après-vente est constamment disponible pour répondre à vos éventuels problèmes.</p>

				<a href="contact.php" class="btn btn-main mt-20">Nous Contacter</a>
...
<section class="team-members ">
	<div class="container">
		<div class="row">
			<div class="title"><h2>Membres de l'equipe</h2></div>
		</div>
		<div class="row">
			<div class="col-md-3">
				<div class="team-member text-center">
					<img class="img-circle" src="images/team/gaspard1.jpg">
					<h4>Gaspard</h4>
					<p>PDG</p>
				</div>
			</div>
			<div class="col-md-3">
				<div class="team-member text-center">
					<img class="img-circle" src="images/team/biche.jpg">
					<h4>Martin</h4>
					<p>Co-PDG</p>
				</div>
			</div>
			<div class="col-md-3">
				<div class="team-member text-center">
					<img class="img-circle" src="images/team/maes.png">
					<h4>Lucie</h4>
					<p>Developpeuse</p>
				</div>
			</div>
			<div class="col-md-3">
				<div class="team-member text-center">
					<img class="img-circle" src="images/team/jean.png">
					<h4>Jean</h4>
					<p>Developpeur</p>
				</div>
			</div>
