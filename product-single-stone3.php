					...
					<div id='carousel-custom' class='carousel slide' data-ride='carousel'>
						<div class='carousel-outer'>
							...
							<div class='carousel-inner '>
								<div class='item active'>
									<img src='images/shop/products/pull-stone-3.1.jpeg' alt='' data-zoom-image="images/shop/single-products/product-1.jpg" />
								</div>
								<div class='item'>
									<img src='images/shop/products/pull-stone-3.2.jpeg' alt='' data-zoom-image="images/shop/single-products/product-2.jpg" />
								</div>
								
								<div class='item'>
									<img src='images/shop/products/pull-stone-3.3.jpeg' alt='' data-zoom-image="images/shop/single-products/product-3.jpg" />
								</div>
								<div class='item'>
									<img src='images/shop/products/pull-stone-3.4.jpeg' alt='' data-zoom-image="images/shop/single-products/product-4.jpg" />
								</div>
						...
						<ol class='carousel-indicators mCustomScrollbar meartlab'>
							<li data-target='#carousel-custom' data-slide-to='0' class='active'>
								<img src='images/shop/products/pull-stone-3.1.jpeg' alt='' />
							</li>
							<li data-target='#carousel-custom' data-slide-to='1'>
								<img src='images/shop/products/pull-stone-3.2.jpeg' alt='' />
							</li>
							<li data-target='#carousel-custom' data-slide-to='2'>
								<img src='images/shop/products/pull-stone-3.3.jpeg'  alt='' />
							</li>
							<li data-target='#carousel-custom' data-slide-to='3'>
								<img src='images/shop/products/pull-stone-3.4.jpeg' alt='' />
							</li>
				...
				<div class="tabCommon mt-20">
					...
					<div class="tab-content patternbg">
						<div id="details" class="tab-pane fade active in">
							...
							<p>	COTTON FLEECE GARMENT DYED : Sweat-shirt à capuche réalisé en coton. Modèle teint en pièce. 100% coton.</p>
							
							<p>Cordon de serrage sur le bord de la capuche. Poches plaquées avec ouverture oblique doublée en ruban de coton. Surpiqûres. Badge Stone Island sur la manche gauche. Poignets et ourlet finement côtelés. Fermeture zippée.</p>
						</div>
