		...
		<div class="row">
			...
			<div class="col-md-6">
				...
				<ol class="breadcrumb">
					...
					<li class="active">GILET A CAPUCHE ABC CAMO SHARK WIDE FIT DOUBLE</li>
		...
		<div class="row mt-20">
					...
					<div id='carousel-custom' class='carousel slide' data-ride='carousel'>
						...
						<div class='carousel-outer'>
							...
							<div class='carousel-inner '>
								...
								<div class='item active'>
									...
									<img src='images/shop/products/pull-bape-2.1.jpeg' alt='' data-zoom-image="images/shop/single-products/product-1.jpg" />

								</div>

								<div class='item'>

									<img src='images/shop/products/pull-bape-2.2.jpeg' alt='' data-zoom-image="images/shop/single-products/product-2.jpg" />
								...
								<div class='item'>
									...
									<img src='images/shop/products/pull-bape-2.3.jpeg' alt='' data-zoom-image="images/shop/single-products/product-3.jpg" />
						...
						<ol class='carousel-indicators mCustomScrollbar meartlab'>
							...
							<li data-target='#carousel-custom' data-slide-to='0' class='active'>
								...
								<img src='images/shop/products/pull-bape-2.1.jpeg' alt='' />

							</li>

							<li data-target='#carousel-custom' data-slide-to='1'>

								<img src='images/shop/products/pull-bape-2.2.jpeg' alt='' />

							</li>

							<li data-target='#carousel-custom' data-slide-to='2'>

								<img src='images/shop/products/pull-bape-2.3.jpeg'  alt='' />
			...
			<div class="col-md-7">
				...
				<div class="single-product-details">
					...
					<h2>GILET A CAPUCHE ABC CAMO SHARK WIDE FIT DOUBLE</h2>

					<p class="product-price">515€</p>
				...
				<div class="tabCommon mt-20">
					...
					<div class="tab-content patternbg">
						...
						<div id="details" class="tab-pane fade active in">
							...
							<p>Gilet à double capuche shark avec capuche intérieur motif ABC Camo. 100% Coton </p>
			...
			<div class="col-md-3">
				...
				<div class="product-item">
					...
					<div class="product-thumb">
						...
						<img class="img-responsive" src="images/shop/products/pull-bape-1.1.jpeg" alt="product-img" />
						...
						<div class="preview-meta">
							...
							<ul>
								...
								<li>
									...
									<a href="product-bape-1.php" ><i class="tf-ion-ios-search-strong"></i></a> 
					...
					<div class="product-content">
						...
						<h4><a href="product-single.php">GILET A CAPUCHE COLOR CAMO SHARK</a></h4>
			...
			<div class="col-md-3">
				...
				<div class="product-item">
					...
					<div class="product-thumb">
						...
						<img class="img-responsive" src="images/shop/products/pull-bape-3.1.jpeg" alt="product-img" />
						...
						<div class="preview-meta">
							...
							<ul>
								...
								<li>
									...
									<a href="product-bape-3.php" ><i class="tf-ion-ios-search-strong"></i></a> 
					...
					<div class="product-content">
						...
						<h4><a href="product-single.php">SWEATSHIRT BAPE X HAJIME SORAYAMA SHARK</a></h4>
			...
			<div class="col-md-3">
				...
				<div class="product-item">
					...
					<div class="product-thumb">
						...
						<img class="img-responsive" src="images/shop/products/pull-bape-4.1.jpeg" alt="product-img" />
						...
						<div class="preview-meta">
							...
							<ul>
								...
								<li>
									...
									<a href="product-bape-4.php" ><i class="tf-ion-ios-search-strong"></i></a> 
					...
					<div class="product-content">
						...
						<h4><a href="product-single.php">Pull ML BAPE X RUSSELL CO</a></h4>
			...
			<div class="col-md-3">
				...
				<div class="product-item">
					...
					<div class="product-thumb">
						...
						<img class="img-responsive" src="images/shop/products/pull-bape-5.1.jpeg" alt="product-img" />
						...
						<div class="preview-meta">
							...
							<ul>
								...
								<li>
									...
									<a href="product-bape-5.php" ><i class="tf-ion-ios-search-strong"></i></a> 
					...
					<div class="product-content">
						...
						<h4><a href="product-single.php">Pull ML BAPE INK RLX 2</a></h4>
