		...
		<div class="row">
			<div class="col-md-6">
				<ol class="breadcrumb">
					...
					<li><a href="shop-CP.php">CP Company</a></li>
					<li class="active">Diagonal Raised Fleece Quarter Zip Sweatshirt</li>
				</ol>
			</div>
		...
		<div class="row mt-20">
					...
					<div id='carousel-custom' class='carousel slide' data-ride='carousel'>
						<div class='carousel-outer'>
							...
							<div class='carousel-inner '>
								<div class='item active'>
									<img src='images/shop/products/pull-CP3.1.jpeg' alt='' data-zoom-image="images/shop/single-products/product-1.jpg" />
								</div>
								<div class='item'>
									<img src='images/shop/products/pull-CP3.2.jpeg' alt='' data-zoom-image="images/shop/single-products/product-2.jpg" />
								</div>
								
								<div class='item'>
									<img src='images/shop/products/pull-CP3.3.jpeg' alt='' data-zoom-image="images/shop/single-products/product-3.jpg" />
								</div>
								<div class='item'>
									<img src='images/shop/products/pull-CP3.4.jpeg' alt='' data-zoom-image="images/shop/single-products/product-4.jpg" />
								</div>
						...
						<ol class='carousel-indicators mCustomScrollbar meartlab'>
							<li data-target='#carousel-custom' data-slide-to='0' class='active'>
								<img src='images/shop/products/pull-CP3.1.jpeg' alt='' />
							</li>
							<li data-target='#carousel-custom' data-slide-to='1'>
								<img src='images/shop/products/pull-CP3.2.jpeg' alt='' />
							</li>
							<li data-target='#carousel-custom' data-slide-to='2'>
								<img src='images/shop/products/pull-CP3.3.jpeg' alt='' />
							</li>
							<li data-target='#carousel-custom' data-slide-to='3'>
								<img src='images/shop/products/pull-CP3.4.jpeg' alt='' />
							</li>
			...
			<div class="col-md-7">
				<div class="single-product-details">
					<h2>Diagonal Raised Fleece Quarter Zip Sweatshirt</h2>
				...
				<div class="tabCommon mt-20">
					...
					<div class="tab-content patternbg">
						<div id="details" class="tab-pane fade active in">
							...
							<p>Ce sweat-shirt présente un col montant resserré à fermeture zippée, une poche avant zippée et une poche arborant le détail en forme de verre de lunette C.P. Company sur la manche. Modèle confectionné dans notre molleton en relief diagonal, un coton bouclé mi-épais offrant un confort absolu et une grande robustesse.</p>
							
							<p>- Molleton de coton en relief diagonal<br>
								- Détail en forme de verre de lunette sur la poche de la manche<br>
								- Col montant<br>							
								- Col zippé<br>
								- Poignets et ourlet côtelés<br>
								- Poche kangourou zippée<br>
								- Coupe droite</p>
						</div>
