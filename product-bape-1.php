		...
		<div class="row">
			...
			<div class="col-md-6">
				...
				<ol class="breadcrumb">
					...
					<li class="active">GILET A CAPUCHE COLOR CAMO SHARK</li>
		...
		<div class="row mt-20">
					...
					<div id='carousel-custom' class='carousel slide' data-ride='carousel'>
						...
						<div class='carousel-outer'>
							...
							<div class='carousel-inner '>
								...
								<div class='item active'>
									...
									<img src='images/shop/products/pull-bape-1.1.jpeg' alt='' data-zoom-image="images/shop/single-products/product-1.jpg" />

								</div>

								<div class='item'>

									<img src='images/shop/products/pull-bape-1.2.jpeg' alt='' data-zoom-image="images/shop/single-products/product-2.jpg" />
								...
								<div class='item'>
									...
									<img src='images/shop/products/pull-bape-1.3.jpeg' alt='' data-zoom-image="images/shop/single-products/product-3.jpg" />
						...
						<ol class='carousel-indicators mCustomScrollbar meartlab'>
							...
							<li data-target='#carousel-custom' data-slide-to='0' class='active'>
								...
								<img src='images/shop/products/pull-bape-1.1.jpeg' alt='' />

							</li>

							<li data-target='#carousel-custom' data-slide-to='1'>

								<img src='images/shop/products/pull-bape-1.2.jpeg' alt='' />

							</li>

							<li data-target='#carousel-custom' data-slide-to='2'>

								<img src='images/shop/products/pull-bape-1.3.jpeg'  alt='' />
			...
			<div class="col-md-7">
				...
				<div class="single-product-details">
					...
					<h2>GILET A CAPUCHE COLOR CAMO SHARK</h2>
