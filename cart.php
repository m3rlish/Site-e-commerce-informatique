          ...
          <div class="block">
            <div class="product-list">
              <form method="post">
                    ...
                    <tr class="">
                      <td class="">
                        <div class="product-info">
                          <img width="80" src="images/shop/products/pull-stone-3.1.jpeg" alt="" />
                          <a href="#!">COTTON FLEECE_GARMENT DYED</a>
                        </div>
                      </td>
                      <td class="">290€</td>
                      <td class="">
                        <a class="product-remove" href="#!">2</a>
                      </td>
                    </tr>
                    <tr class="">
                      <td class="">
                        <div class="product-info">
                          <img width="80" src="images/shop/products/pull-CP-2.1.jpeg" alt="" />
                          <a href="#!">Light Fleece Zipped Hoodie</a>
                        </div>
                      </td>
                      <td class="">210€</td>
                      <td class="">
                        <a class="product-remove" href="#!">1</a>
                      </td>
                    </tr>
                    <tr class="">
                      <td class="">
                        <div class="product-info">
                          <img width="80" src="images/shop/products/pull-CP-5.1.jpeg" alt="" />
                          <a href="#!">Diagonal Raised Fleece Zipped Sweatshirt</a>
                        </div>
                      </td>
                      <td class="">189€</td>
                      <td class="">
                ...
                <a href="checkout.php" class="btn btn-main pull-right">Payament</a>
              </form>
            </div>
          </div>
        </div>
