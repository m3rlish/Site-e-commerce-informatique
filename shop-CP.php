...
<section class="page-header">
	<div class="container">
		<div class="row">
			<div class="col-md-12">
				<div class="content">
					<h1 class="page-name">CP Company</h1>
					<ol class="breadcrumb">
	...
	<div class="container">
		<div class="row">
			...
			<div class="col-md-4">
				<div class="product-item">
					<div class="product-thumb">
						<img class="img-responsive" src="images/shop/products/pull-CP-6.1.jpeg" alt="product-img" />
						<div class="preview-meta">
							<ul>
								<li>
									<a href="product-single-CP6.php" ><i class="tf-ion-ios-search-strong"></i></a> 
								</li>
								<li>
			                        <a href="#" ><i class="tf-ion-ios-heart"></i></a>
								</li>
					...
					<div class="product-content">
						<h4><a href="product-single.php">Cotton Fleece Resist Dyed Sweatshirt</a></h4>
						<p class="price">189€</p>
					</div>
				</div>
			</div>
