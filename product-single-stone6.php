		...
		<div class="row">
			<div class="col-md-6">
				<ol class="breadcrumb">
					...
					<li class="active">COTTON FLEECE 'REEF CAMO' PRINT - SI MARINA</li>
				</ol>
			</div>
		...
		<div class="row mt-20">
					...
					<div id='carousel-custom' class='carousel slide' data-ride='carousel'>
						<div class='carousel-outer'>
							...
							<div class='carousel-inner '>
								<div class='item active'>
									<img src='images/shop/products/pull-stone-6.1.jpeg' alt='' data-zoom-image="images/shop/single-products/product-1.jpg" />
								</div>
								<div class='item'>
									<img src='images/shop/products/pull-stone-6.2.jpeg' alt='' data-zoom-image="images/shop/single-products/product-2.jpg" />
								</div>
								
								<div class='item'>
									<img src='images/shop/products/pull-stone-6.3.jpeg' alt='' data-zoom-image="images/shop/single-products/product-3.jpg" />
								</div>
								<div class='item'>
									<img src='images/shop/products/pull-stone-6.4.jpeg' alt='' data-zoom-image="images/shop/single-products/product-4.jpg" />
								</div>
						...
						<ol class='carousel-indicators mCustomScrollbar meartlab'>
							<li data-target='#carousel-custom' data-slide-to='0' class='active'>
								<img src='images/shop/products/pull-stone-6.1.jpeg' alt='' />
							</li>
							<li data-target='#carousel-custom' data-slide-to='1'>
								<img src='images/shop/products/pull-stone-6.2.jpeg' alt='' />
							</li>
							<li data-target='#carousel-custom' data-slide-to='2'>
								<img src='images/shop/products/pull-stone-6.3.jpeg'  alt='' />
							</li>
							<li data-target='#carousel-custom' data-slide-to='3'>
								<img src='images/shop/products/pull-stone-6.4.jpeg' alt='' />
							</li>
			...
			<div class="col-md-7">
				<div class="single-product-details">
					<h2>COTTON FLEECE 'REEF CAMO' PRINT - SI MARINA</h2>
				...
				<div class="tabCommon mt-20">
					...
					<div class="tab-content patternbg">
						<div id="details" class="tab-pane fade active in">
							...
							<p>COTTON FLEECE 'REEF CAMO' PRINT - SI MARINA : Sweat-shirt ras-du-cou en coton avec imprimé ’Reef Camo’ sur l’ensemble. 100% coton.</p>
							
							<p>Col côtelé. Broderie petite étoile Stone Island Marina rouge au milieu de la poitrine. Inscription Stone Island Marina caoutchoutée en relief imprimée au dos. Poignets côtelés.</p>
						</div>
