		...
		<div class="row">
			<div class="col-md-6">
				<ol class="breadcrumb">
					...
					<li class="active">COTTON FLEECE_GARMENT DYED</li>
				</ol>
			</div>
		...
		<div class="row mt-20">
					...
					<div id='carousel-custom' class='carousel slide' data-ride='carousel'>
						<div class='carousel-outer'>
							...
							<div class='carousel-inner '>
								<div class='item active'>
									<img src='images/shop/products/pull-stone-1.1.jpeg' alt='' data-zoom-image="images/shop/single-products/product-1.jpg" />
								</div>
								<div class='item'>
									<img src='images/shop/products/pull-stone-1.2.jpeg' alt='' data-zoom-image="images/shop/single-products/product-2.jpg" />
								</div>
								
								<div class='item'>
									<img src='images/shop/products/pull-stone-1.3.jpeg' alt='' data-zoom-image="images/shop/single-products/product-3.jpg" />
								</div>
								<div class='item'>
									<img src='images/shop/products/pull-stone-1.4.jpeg' alt='' data-zoom-image="images/shop/single-products/product-4.jpg" />
								</div>
								<div class='item'>
									<img src='images/shop/products/pull-stone-1.4.jpeg' alt='' data-zoom-image="images/shop/single-products/product-5.jpg" />
								</div>
						...
						<ol class='carousel-indicators mCustomScrollbar meartlab'>
							<li data-target='#carousel-custom' data-slide-to='0' class='active'>
								<img src='images/shop/products/pull-stone-1.1.jpeg' alt='' />
							</li>
							<li data-target='#carousel-custom' data-slide-to='1'>
								<img src='images/shop/products/pull-stone-1.2.jpeg' alt='' />
							</li>
							<li data-target='#carousel-custom' data-slide-to='2'>
								<img src='images/shop/products/pull-stone-1.3.jpeg' alt='' />
							</li>
							<li data-target='#carousel-custom' data-slide-to='3'>
								<img src='images/shop/products/pull-stone-1.4.jpeg' alt='' />
							</li>
			...
			<div class="col-md-7">
				<div class="single-product-details">
					<h2>COTTON FLEECE_GARMENT DYED</h2>
				...
				<div class="tabCommon mt-20">
					...
					<div class="tab-content patternbg">
						<div id="details" class="tab-pane fade active in">
							...
							<p>	COTTON FLEECE GARMENT DYED : Sweat-shirt à col rond en coton. Modèle teint en pièce. 100% coton.</p>
							
							<p>Col côtelé. Badge Stone Island sur la manche gauche. Coutures overlock. Dos du pied de col doublé. Poignets et ourlet finement côtelés.</p>
						</div>
		...
		<div class="row">
			...
			<div class="col-md-3">
				<div class="product-item">
					...
					<div class="product-content">
						<h4><a href="product-single.php">SOFT COTTON</a></h4>
						<p class="price">320€</p>
					</div>
				</div>
			</div>
