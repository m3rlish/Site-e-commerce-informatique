...
<section class="page-header">
	<div class="container">
		<div class="row">
			<div class="col-md-12">
				<div class="content">
					<h1 class="page-name">Nous Contacter</h1>
					<ol class="breadcrumb">
			...
			<div class="row">
				...
				<div class="contact-form col-md-6 " >
					<form id="contact-form" method="post" action="" role="form">
						...
						<div id="cf-submit">
							<input type="Envoyer" id="contact-submit" class="btn btn-transparent" value="Envoyer">
						</div>						
				...
				<div class="contact-details col-md-6 " >
					...
					<ul class="contact-short-info" >
						...
						<li>
							...
							<span>Téléphone: 03 20 48 34 56</span>
						</li>
						<li>
							<i class="tf-ion-android-globe"></i>
							<span>Fax: 03 20 48 34 56</span>
						</li>
						<li>
							<i class="tf-ion-android-mail"></i>
							<span>Email: SNKRS@gmail.com</span>
						</li>
					</ul>
					<!-- Footer Social Links -->
