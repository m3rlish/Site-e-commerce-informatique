		...
		<div class="row">
			<div class="col-md-6">
				<ol class="breadcrumb">
					...
					<li class="active">MALFILE' FLEECE_GARMENT DYED 'OLD' EFFECT</li>
				</ol>
			</div>
		...
		<div class="row mt-20">
					...
					<div id='carousel-custom' class='carousel slide' data-ride='carousel'>
						<div class='carousel-outer'>
							...
							<div class='carousel-inner '>
								<div class='item active'>
									<img src='images/shop/products/pull-stone-2.1.jpeg' alt='' data-zoom-image="images/shop/single-products/product-1.jpg" />
								</div>
								<div class='item'>
									<img src='images/shop/products/pull-stone-2.2.jpeg' alt='' data-zoom-image="images/shop/single-products/product-2.jpg" />
								</div>
								
								<div class='item'>
									<img src='images/shop/products/pull-stone-2.3.jpeg' alt='' data-zoom-image="images/shop/single-products/product-3.jpg" />
								</div>
								<div class='item'>
									<img src='images/shop/products/pull-stone-2.4.jpeg' alt='' data-zoom-image="images/shop/single-products/product-4.jpg" />
								</div>
						...
						<ol class='carousel-indicators mCustomScrollbar meartlab'>
							<li data-target='#carousel-custom' data-slide-to='0' class='active'>
								<img src='images/shop/products/pull-stone-2.1.jpeg' alt='' />
							</li>
							<li data-target='#carousel-custom' data-slide-to='1'>
								<img src='images/shop/products/pull-stone-2.2.jpeg' alt='' />
							</li>
							<li data-target='#carousel-custom' data-slide-to='2'>
								<img src='images/shop/products/pull-stone-2.3.jpeg'  alt='' />
							</li>
							<li data-target='#carousel-custom' data-slide-to='3'>
								<img src='images/shop/products/pull-stone-2.4.jpeg' alt='' />
							</li>
			...
			<div class="col-md-7">
				<div class="single-product-details">
					<h2>MALFILE' FLEECE_GARMENT DYED 'OLD' EFFECT</h2>
				...
				<div class="tabCommon mt-20">
					...
					<div class="tab-content patternbg">
						<div id="details" class="tab-pane fade active in">
							...
							<p>	MALFILE' FLEECE_GARMENT DYED 'OLD' EFFECT : Sweat-shirt à capuche réalisé en molleton flammé. Modèle teint en pièce pour créer l'effet 'OLD', un traitement exclusif comprenant une teinture suivie d’une décoloration sur la pièce finie pour obtenir un aspect légèrement usé et en relief. 100% coton.</p>
							
							<p>Cordon de serrage sur le bord de la capuche. Petit empiècement triangulaire côtelé au milieu du col. Manches raglan. Badge Stone Island sur la manche gauche. Poignets et ourlet finement côtelés.</p>
						</div>
	...
	<div class="container">
		...
		<div class="row">
			...
			<div class="col-md-3">
				<div class="product-item">
					<div class="product-thumb">
						<img class="img-responsive" src="images/shop/products/pull-stone-5.1.jpeg" alt="product-img" />
						<div class="preview-meta">
							<ul>
								<li>
									<a href="product-single-stone5.php" ><i class="tf-ion-ios-search-strong"></i></a> 
								</li>
								<li>
			                        <a href="#" ><i class="tf-ion-ios-heart"></i></a>
								</li>
					...
					<div class="product-content">
						<h4><a href="product-single.php">SOFT COTON</a></h4>
						<p class="price">320€</p>
					</div>
				</div>
			</div>
			<div class="col-md-3">
				<div class="product-item">
					<div class="product-thumb">
						<img class="img-responsive" src="images/shop/products/pull-stone-6.1.jpeg" alt="product-img" />
						<div class="preview-meta">
							<ul>
								<li>
									<a href="product-single-stone6.php" ><i class="tf-ion-ios-search-strong"></i></a> 
								</li>
								<li>
			                        <a href="#" ><i class="tf-ion-ios-heart"></i></a>
								</li>
					...
					<div class="product-content">
						<h4><a href="product-single.php">COTTON SWEAT CAMO</a></h4>
						<p class="price">310€</p>
					</div>
				</div>
			</div>
