							...
							<div class="row">
								...
								<div class="col-lg-10 col-md-6 mb-sm-3">
									<ul>
										...
										<li><a href="shop.html">Stone Island</a></li>
										<li><a href="shop-CP.html">CP Company</a></li>
										<li><a href="shop.html">Bape</a></li>
    ...
    <div class="container">
      <div class="row">
        <div class="col-lg-8 text-center">
          ...
          <a data-duration-in=".3" data-animation-in="fadeInUp" data-delay-in=".8" class="btn" href="shop.html">Acheter Maintenant</a>
        </div>
      </div>
    </div>
  </div>
    ...
    <div class="container">
      <div class="row">
        <div class="col-lg-8 text-left">
          ...
          <a data-duration-in=".3" data-animation-in="fadeInUp" data-delay-in=".8" class="btn" href="shop-CP.html">Acheter Maintenant</a>
        </div>
      </div>
    </div>
  </div>
    ...
    <div class="container">
      <div class="row">
        <div class="col-lg-8 text-right">
          ...
          <a data-duration-in=".3" data-animation-in="fadeInUp" data-delay-in=".8" class="btn" href="shop.html">SAcheter Maintenant</a>
        </div>
      </div>
    </div>
  </div>
				...
				<div class="product-item">
					<div class="product-thumb">
						...
						<div class="preview-meta">
							<ul>
								<li>
									<a href="product-single-stone1.html" ><i class="tf-ion-ios-search-strong"></i></a> 
								</li>
								<li>
					...
					<div class="product-content">
						<h4><a href="product-single.html">Moleton</a></h4>
						<p class="price">220€</p>
					</div>
				</div>
			</div>
				...
				<div class="product-item">
					<div class="product-thumb">
						...
						<div class="preview-meta">
							<ul>
								<li>
									<a href="product-single-stone2.html" ><i class="tf-ion-ios-search-strong"></i></a> 
								</li>
								<li>
			                        <a href="#" ><i class="tf-ion-ios-heart"></i></a>
								</li>
					...
					<div class="product-content">
						<h4><a href="product-single.html">Sweat à capuche</a></h4>
						<p class="price">240€</p>
					</div>
				</div>
			</div>
					...
					<div class="product-item">
						<div class="product-thumb">
							...
							<div class="preview-meta">
								<ul>
									<li>
										<a href="product-single-stone3.html" ><i class="tf-ion-ios-search-strong"></i></a> 
									</li>
									<li>
										<a href="#" ><i class="tf-ion-ios-heart"></i></a>
									</li>
						...
						<div class="product-content">
							<h4><a href="product-single.html">Gilet à capuche</a></h4>
							<p class="price">260€</p>
						</div>
					</div>
				</div>
