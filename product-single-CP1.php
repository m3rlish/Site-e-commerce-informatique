		...
		<div class="row">
			<div class="col-md-6">
				<ol class="breadcrumb">
					...
					<li><a href="shop-CP.php">CP Company</a></li>
					<li class="active">Chenille Cotton Crew Neck Knit</li>
				</ol>
			</div>
		...
		<div class="row mt-20">
					...
					<div id='carousel-custom' class='carousel slide' data-ride='carousel'>
						<div class='carousel-outer'>
							...
							<div class='carousel-inner '>
								<div class='item active'>
									<img src='images/shop/products/pull-CP-1.1.jpeg' alt='' data-zoom-image="images/shop/single-products/product-1.jpg" />
								</div>
								<div class='item'>
									<img src='images/shop/products/pull-CP-1.2.jpeg' alt='' data-zoom-image="images/shop/single-products/product-2.jpg" />
								</div>
								
								<div class='item'>
									<img src='images/shop/products/pull-CP-1.3.jpeg' alt='' data-zoom-image="images/shop/single-products/product-3.jpg" />
								</div>
								<div class='item'>
									<img src='images/shop/products/pull-CP-1.4.jpeg' alt='' data-zoom-image="images/shop/single-products/product-4.jpg" />
								</div>
						...
						<ol class='carousel-indicators mCustomScrollbar meartlab'>
							<li data-target='#carousel-custom' data-slide-to='0' class='active'>
								<img src='images/shop/products/pull-CP-1.1.jpeg' alt='' />
							</li>
							<li data-target='#carousel-custom' data-slide-to='1'>
								<img src='images/shop/products/pull-CP-1.2.jpeg' alt='' />
							</li>
							<li data-target='#carousel-custom' data-slide-to='2'>
								<img src='images/shop/products/pull-CP-1.3.jpeg' alt='' />
							</li>
							<li data-target='#carousel-custom' data-slide-to='3'>
								<img src='images/shop/products/pull-CP-1.4.jpeg' alt='' />
							</li>
			...
			<div class="col-md-7">
				<div class="single-product-details">
					<h2>Chenille Cotton Crew Neck Knit</h2>
				...
				<div class="tabCommon mt-20">
					...
					<div class="tab-content patternbg">
						<div id="details" class="tab-pane fade active in">
							...
							<p>Ce sweat-shirt présente un col ras du cou épuré, des finitions côtelées au niveau du col et des manches, ainsi qu'une poche sécurisée sur le bras, ornée du détail en forme de verre de lunette C.P. Company. Tricoté dans des fils de coton chenille classiques et teint en pièce pour plus de profondeur et d'intensité dans les couleurs, il offre une maille confortable et isolante d'une incomparable douceur</p>
							
							<p>- Col ras du cou<br>
								- Col et poignets côtelés<br>
								- Détail en forme de verre de lunette sur la poche de la manche<br>
								- Coutures ton sur ton<br>
								- Teint en pièce</p>
						</div>
