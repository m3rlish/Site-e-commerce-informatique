		...
		<div class="row">
			<div class="col-md-6">
				<ol class="breadcrumb">
					...
					<li><a href="shop-CP.php">CP Company</a></li>
					<li class="active">Cotton Fleece Resist Dyed Sweatshirt</li>
				</ol>
			</div>
		...
		<div class="row mt-20">
					...
					<div id='carousel-custom' class='carousel slide' data-ride='carousel'>
						<div class='carousel-outer'>
							...
							<div class='carousel-inner '>
								<div class='item active'>
									<img src='images/shop/products/pull-CP-6.1.jpeg' alt='' data-zoom-image="images/shop/single-products/product-1.jpg" />
								</div>
								<div class='item'>
									<img src='images/shop/products/pull-CP-6.2.jpeg' alt='' data-zoom-image="images/shop/single-products/product-2.jpg" />
								</div>
								
								<div class='item'>
									<img src='images/shop/products/pull-CP-6.3.jpeg' alt='' data-zoom-image="images/shop/single-products/product-3.jpg" />
								</div>
								<div class='item'>
									<img src='images/shop/products/pull-CP-6.4.jpeg' alt='' data-zoom-image="images/shop/single-products/product-4.jpg" />
								</div>
						...
						<ol class='carousel-indicators mCustomScrollbar meartlab'>
							<li data-target='#carousel-custom' data-slide-to='0' class='active'>
								<img src='images/shop/products/pull-CP-6.1.jpeg' alt='' />
							</li>
							<li data-target='#carousel-custom' data-slide-to='1'>
								<img src='images/shop/products/pull-CP-6.2.jpeg' alt='' />
							</li>
							<li data-target='#carousel-custom' data-slide-to='2'>
								<img src='images/shop/products/pull-CP-6.3.jpeg' alt='' />
							</li>
							<li data-target='#carousel-custom' data-slide-to='3'>
								<img src='images/shop/products/pull-CP-6.4.jpeg' alt='' />
							</li>
			...
			<div class="col-md-7">
				<div class="single-product-details">
					<h2>Cotton Fleece Resist Dyed Sweatshirt
					</h2>
				...
				<div class="tabCommon mt-20">
					...
					<div class="tab-content patternbg">
						<div id="details" class="tab-pane fade active in">
							...
							<p>Ce sweat-shirt à col ras du cou arbore un logo C.P. Company discret sur la poitrine. Modèle confectionné dans notre polaire de coton mi-épaisse classique, puis teint par réserve pour un fini ton sur ton contrasté.
							</p>
							
							<p>- Col ras du cou<br>
								- Logo sur la poitrine<br>
