...
<div class="hero-slider">
  <div class="slider-item th-fullpage hero-area" style="background-image: url(images/shop/products/stone-index.jpeg);">
    <div class="container">
      <div class="row">
    ...
    <div class="container">
      <div class="row">
        <div class="col-lg-8 text-right">
          ...
          <a data-duration-in=".3" data-animation-in="fadeInUp" data-delay-in=".8" class="btn" href="shop-bape.php">Acheter Maintenant</a>
        </div>
      </div>
    </div>
  </div>
